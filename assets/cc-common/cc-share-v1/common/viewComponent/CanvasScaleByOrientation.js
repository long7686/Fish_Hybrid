...
cc.Class({
    ...
    scaleCanvasByOrientation() {
        ...
        if (this.canvas) {
            ...
            if (this.fitByOrientation) {
                const designRatio = this.useCustomDesignResolution? this.customDSWidth/this.customDSHeight : this.canvas.designResolution.width / this.canvas.designResolution.height;
    ...
    onScreenResized() {
        ...
        this.scaleCanvasByOrientation();
        this.isDebug && cc.log(`ON SCREEN RESIZE: NEW CANVAS SIZE: Width: ${canvasSize.width}, Height: ${canvasSize.height}`);
    },
