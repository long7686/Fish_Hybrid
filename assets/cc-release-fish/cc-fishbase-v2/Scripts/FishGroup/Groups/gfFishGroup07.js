...
class gfFishGroup7 {
    ...
    static create(){
        ...
        // const fishKind = [13, 3, 4, 25, 43, 25, 30];
        const Y1 = 140;
        const space = 175;
        const speed = 150;
        ...
        const offsetX = 80;
        const timeEach = 5;
        this.makeBezierLine(fishCount[1] / 2, cc.v2(-100, -100), offsetX, 3, timeEach);
        this.makeBezierLine(fishCount[1] / 2, cc.v2(-100, AppSize.Height + 100), offsetX, 3, timeEach);
    ...
    static makeBezierLine(fishCount, startPos, offsetX, circleCount, moveInTime, circleTime = moveInTime ) {
        ...
        for(let i = 0; i < fishCount; ++i) {
            ...
            moveAction.appendAction(FISH_ACTION.gfBezierBy, { time: moveInTime, points: 
                [cc.v2(0, -y / 3), 
                    cc.v2(FishGroupData.flipCoord * x * 0.35, -y), 
                    cc.v2(FishGroupData.flipCoord * x, -y)]});
