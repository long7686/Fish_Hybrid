if (window.boot = function() {
    ...
    var E = e.jsList,
        _ = e.debug ? "src/project.dev.js" : "src/project.a87ca.js";
...
isRuntime ? (require("src/settings.7083c.js"), require("src/cocos2d-runtime.js"), require("jsb-adapter/engine/index.js")) : (require("src/settings.7083c.js"), require("src/cocos2d-jsb.js"), require("jsb-adapter/jsb-engine.js")), cc.macro.CLEANUP_IMAGE_CACHE = !0, window.boot()
}